...
public final class BulkDeleteCommand extends Command {
	...
	public BulkDeleteCommand(Object[] keys, BitSet flagMap, String providerName, int onDsItemRemovedId) {
		this.name = "DELETEBULK";
			...
			throw new IllegalArgumentException(
                ...
                builder = builder.addAllKeys(list)
                 ...
                 if(providerName != null) builder = builder.setProviderName(providerName);
                    ...
                    commandBuilder = commandBuilder.setBulkDeleteCommand(builder)
                        .setRequestID(this.getRequestId())
                        .setType(CommandProtocol.Command.Type.DELETE_BULK)
