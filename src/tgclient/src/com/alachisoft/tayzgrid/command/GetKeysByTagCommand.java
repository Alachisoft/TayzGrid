...
public class GetKeysByTagCommand extends Command {

    private String[] _tags;
    private TagComparisonType _comparisonType;

    public GetKeysByTagCommand(String[] tags, TagComparisonType comparisonType) {
        super.name = "GETKEYSTAG ";
    ...
    protected void createCommand() throws CommandException {
        GetKeysByTagCommandProtocol.GetKeysByTagCommand.Builder builder =
                GetKeysByTagCommandProtocol.GetKeysByTagCommand.newBuilder();
        ...
        try {
            ...
            commandBuilder = commandBuilder.setGetKeysByTagCommand(builder)
                    .setRequestID(this.getRequestId())
                    .setType(CommandProtocol.Command.Type.GET_KEYS_TAG)
    ...
    public CommandType getCommandType() {
         return CommandType.GET_KEYS_TAG;
    }
