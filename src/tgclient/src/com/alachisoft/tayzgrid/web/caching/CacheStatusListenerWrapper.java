...
class CacheStatusListenerWrapper
{

    CacheStatusEventListener _cacheEventListener = null;

    public CacheStatusListenerWrapper(CacheStatusEventListener listener)
    {
     ...
     */
    public void setClusterEvent(CacheStatusEventListener _cacheEvent)
    {
     ...
     */
    public CacheStatusEventListener getClusterEvent()
    {
     ...
     */
    public boolean verifyListenerInstance(CacheStatusEventListener listener)
    {
    ...
    {
        return ((CacheStatusListenerWrapper)obj).getClusterEvent() == _cacheEventListener;
    }
