...
import com.alachisoft.tayzgrid.socketserver.command.responsebuilders.SearchResponseBuilder;
...
public class SearchCommand extends CommandBase
{
    ...
    public void ExecuteCommand(ClientManager clientManager, com.alachisoft.tayzgrid.common.protobuf.CommandProtocol.Command command)
    {
        ...
        try
        {
            ...
            ResponseProtocol.Response response = ResponseProtocol.Response.newBuilder().setSearch(SearchResponseBuilder.BuildResponse(resultSet, cmdInfo.CommandVersion, nCache.getCacheId())).setRequestId(Long.parseLong(cmdInfo.RequestId)).setResponseType(ResponseProtocol.Response.Type.SEARCH).build();
    ...
    private Object GetValueObject(String value) throws Exception
    {
        ...
        try
        {
            ...
            if (objType == java.util.Date.class)
            {
