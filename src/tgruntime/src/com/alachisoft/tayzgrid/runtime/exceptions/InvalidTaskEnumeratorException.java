 ...
 */
public class InvalidTaskEnumeratorException extends CacheException
{
     ...
     */
    public InvalidTaskEnumeratorException(java.lang.String s)
    {
        super(s);
     }

    public InvalidTaskEnumeratorException(java.lang.String s, Throwable exception)
    {
        super(s, exception);
    }
}
