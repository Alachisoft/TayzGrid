/*
 * @(#)SqlTimeSerializationSurrogate.java	1.0
 *
...
/**
 * SqlTimeSerializationSurrogate is responsible for writing and reading
 * instances of java.sql.Time class.
 *
 * @version 1.0, September 18, 2008
 */
public class SqlTimeSerializationSurrogate
        ...
        implements SerializationSurrogate, BuiltinSerializationSurrogate
{
    ...
    public SqlTimeSerializationSurrogate()
    {
        super(Time.class);
    }
 ...
 related exceptions occur.
            ...
            throws CacheIOException
    {
        try
        {
            output.writeLong(((Time) graph).getTime());
        }
        catch (IOException ex)
        {
            throw new CacheIOException(ex);
