/*
 * @(#)UUIDSerializationSurrogate.java	1.0
 *
...
/**
 * UUIDSerializationSurrogate is responsible for writing and reading
 * instances of UUID class.
 *
 * @version 1.0, September 18, 2008
 */
public class UUIDSerializationSurrogate
        ...
        implements SerializationSurrogate, BuiltinSerializationSurrogate
{
    ...
    public UUIDSerializationSurrogate()
    {
        super(UUID.class);
    }
 ...
 related exceptions occur.
            ...
            throws CacheIOException
    {
        try
        {
            output.writeUTF(((UUID)graph).toString());
        }
        catch (IOException ex)
        {
            throw new CacheIOException(ex);
