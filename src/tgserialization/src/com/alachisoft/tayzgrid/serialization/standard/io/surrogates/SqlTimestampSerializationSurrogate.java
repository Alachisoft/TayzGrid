/*
 * @(#)SqlTimestampSerializationSurrogate.java	1.0
 *
...
/**
 * SqlTimestampSerializationSurrogate is responsible for writing and reading
 * instances of java.sql.Timestamp class.
 *
 * @version 1.0, September 18, 2008
 */
public class SqlTimestampSerializationSurrogate
        ...
        implements SerializationSurrogate, BuiltinSerializationSurrogate
{
    ...
    public SqlTimestampSerializationSurrogate()
    {
 ...
 related exceptions occur.
            ...
            throws CacheIOException
    {
        try
        {
            output.writeLong(((Timestamp) graph).getTime());
        }
        catch (IOException ex)
        {
            throw new CacheIOException(ex);
