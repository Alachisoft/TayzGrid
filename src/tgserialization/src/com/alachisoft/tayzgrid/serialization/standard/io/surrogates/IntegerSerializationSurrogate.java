/*
 * @(#)IntegerSerializationSurrogate.java	1.0
 *
...
/**
 * IntegerSerializationSurrogate is responsible for writing and reading
 * instances of Integer class.
 *
 * @version 1.0, September 18, 2008
 */
public class IntegerSerializationSurrogate
        extends SerializationSurrogateBase
        implements SerializationSurrogate, BuiltinSerializationSurrogate
{

    /**
     * Creates a new instance of IntegerSerializationSurrogate
     */
    public IntegerSerializationSurrogate()
    {
        super(Integer.class);
    }
