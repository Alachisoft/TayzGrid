/*
 * @(#)DoubleSerializationSurrogate.java	1.0
 *
...
/**
 * DoubleSerializationSurrogate is responsible for writing and reading
 * instances of Double class.
 *
 * @version 1.0, September 18, 2008
 */
public class DoubleSerializationSurrogate
        ...
        implements SerializationSurrogate, BuiltinSerializationSurrogate
{
    ...
    public DoubleSerializationSurrogate()
    {
        super(Double.class);
    }
 ...
 related exceptions occur.
            ...
            throws CacheIOException
    {
        try
        {
            output.writeDouble((Double) graph);
        }
        catch (IOException ex)
        {
            throw new CacheIOException(ex);
