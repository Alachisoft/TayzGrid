/*
 * @(#)BooleanArraySerializationSurrogate.java	1.0
 *
...
/**
 * BooleanArraySerializationSurrogate is responsible for writing and reading
 * instances of boolean[] class.
 *
 * @version 1.0, September 18, 2008
 */
public class BooleanArraySerializationSurrogate extends SerializationSurrogateImpl implements BuiltinSerializationSurrogate
{

    /** Creates a new instance of NxObjectArraySerializationSurrogate */
    public BooleanArraySerializationSurrogate()
    {
        super(boolean[].class);
    }
     ...
     * in the sense that an NCacheNCacheObjectInput object is passed as parameter that can be used to read creation specific
    ...
    public void writeDirect(CacheObjectOutput output, Object graph) throws CacheIOException
    {
        ...
        try
        {
            ...
            {
                bout.writeInt(len);
                bout.writeBooleans(array, 0, len);
            }
            else
            {
                output.writeInt(len);
    ...
    public void skipDirect(CacheObjectInput input, Object graph) throws CacheInstantiationException, CacheIOException
    {
        ...
        try
        {
            //can be optimized to input.Bytes(len); but to maintain architecture knowledge it is kept in a loop
            for (int i = 0; i < len; i++)
            {
                input.skipBoolean();
            }
