...
public class UnsignedByteSerializationSurrogate extends SerializationSurrogateBase implements SerializationSurrogate, BuiltinSerializationSurrogate
{

    /** Creates a new instance of BigIntegerSerializationSurrogate */
    public UnsignedByteSerializationSurrogate()
    {
        super(UnsignedByteSerializationSurrogate.class);
    }
