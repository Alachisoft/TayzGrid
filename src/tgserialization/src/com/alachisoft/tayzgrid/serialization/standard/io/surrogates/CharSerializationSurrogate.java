/*
 * @(#)CharSerializationSurrogate.java	1.0
 *
...
/**
 * CharSerializationSurrogate is responsible for writing and reading
 * instances of Character class.
 *
 * @version 1.0, September 18, 2008
 */
public class CharSerializationSurrogate
        extends SerializationSurrogateBase
        implements SerializationSurrogate, BuiltinSerializationSurrogate
{

    /**
     * Creates a new instance of CharSerializationSurrogate
     */
    public CharSerializationSurrogate()
    {
 ...
 related exceptions occur.
            ...
            throws CacheIOException
    {
        try
        {
            output.writeChar((Character) graph);
        }
        catch (IOException ex)
        {
            throw new CacheIOException(ex);
