...
public class BigDecimalSerializationSurrogate extends SerializationSurrogateBase implements SerializationSurrogate, BuiltinSerializationSurrogate
{

    /** Creates a new instance of BigIntegerSerializationSurrogate */
    public BigDecimalSerializationSurrogate()
    {
 ...
 related exceptions occur.
    ...
    public Object readObject(CacheObjectInput input) throws CacheInstantiationException, CacheIOException
    {
        try
        {
            return new BigDecimal((String)input.readObject());
        }
        ...
        {
            throw new CacheIOException(ex1);
        }
    }
            ...
            throws CacheIOException
    {
        try
        {
            BigDecimal bigD = (BigDecimal)graph;
            output.writeObject(bigD.toPlainString());
        }
        catch (IOException ex)
        {
            throw new CacheIOException(ex);
