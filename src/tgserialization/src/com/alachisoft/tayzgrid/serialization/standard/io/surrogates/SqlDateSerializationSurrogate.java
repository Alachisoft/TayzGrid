/*
 * @(#)SqlDateSerializationSurrogate.java	1.0
 *
...
/**
 * SqlDateSerializationSurrogate is responsible for writing and reading
 * instances of java.sql.Date class.
 *
 * @version 1.0, September 18, 2008
 */
public class SqlDateSerializationSurrogate
        ...
        implements SerializationSurrogate, BuiltinSerializationSurrogate
{
    ...
    public SqlDateSerializationSurrogate()
    {
        super(Date.class);
    }
 ...
 related exceptions occur.
            ...
            throws CacheIOException
    {
        try
        {
            output.writeLong(((Date) graph).getTime());
        }
        catch (IOException ex)
        {
            throw new CacheIOException(ex);
