...
public class UInt32SerializationSurrogate extends SerializationSurrogateBase implements SerializationSurrogate, BuiltinSerializationSurrogate
{

    /** Creates a new instance of LongSerializationSurrogate */
    public UInt32SerializationSurrogate()
    {
        super(UInt32SerializationSurrogate.class);
    }
