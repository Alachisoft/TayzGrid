/*
 * @(#)BooleanSerializationSurrogate.java	1.0
 *
...
/**
 * BooleanSerializationSurrogate is responsible for writing and reading
 * instances of Boolean class.
 *
 * @version 1.0, September 18, 2008
 */
public class BooleanSerializationSurrogate
        extends SerializationSurrogateBase
        implements SerializationSurrogate, BuiltinSerializationSurrogate
{

    /** Creates a new instance of BooleanSerializationSurrogate */
    public BooleanSerializationSurrogate()
    {
        super(Boolean.class);
    }
 ...
 related exceptions occur.
            ...
            throws CacheIOException
    {
        try
        {
            output.writeBoolean((Boolean) graph);
        }
        catch (IOException ex)
        {
            throw new CacheIOException(ex);
