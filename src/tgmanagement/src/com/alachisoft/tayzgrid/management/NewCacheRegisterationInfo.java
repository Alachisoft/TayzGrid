...
{
    private com.alachisoft.tayzgrid.config.newdom.CacheServerConfig _updatedCacheConfig;
    ...
    public NewCacheRegisterationInfo(com.alachisoft.tayzgrid.config.newdom.CacheServerConfig cacheConfig, java.util.ArrayList nodesList, java.util.ArrayList affectedPartitions)
    {
    ...
    public final com.alachisoft.tayzgrid.config.newdom.CacheServerConfig getUpdatedCacheConfig()
    {
    ...
    public final java.util.ArrayList getAffectedPartitions()
    {
        ...
        {
            _updatedCacheConfig = (com.alachisoft.tayzgrid.config.newdom.CacheServerConfig) Common.readAs(reader.ReadObject(),com.alachisoft.tayzgrid.config.newdom.CacheServerConfig.class);
