 ...
 */
public class AsyncInsert implements AsyncProcessor.IAsyncTask
{
     ...
     * @param evictionHint
     */
    public AsyncInsert(Cache cache, Object key, Object value, ExpirationHint expiryHint, EvictionHint evictionHint, String group, String subGroup, BitSet Flag, java.util.HashMap queryInfo, String providerName, String resyncProviderName, OperationContext operationContext)
    {
        _cache = cache;
        _key = key;
        _value = value;
    ...
    public void Process()
    {
        ...
        try
        {
            ...
            _cache.Insert(_key, _value, _expiryHint, _evictionHint, _group, _subGroup, _queryInfo, _flag, null, 0, LockAccessType.IGNORE_LOCK,_providerName,_resyncProviderName,_operationContext);
        ...
        catch (Exception e)
        {
            if (getCacheLog() != null)
            {
                getCacheLog().Error("AsyncInsert.Process()", e.getMessage());
            }
            result = e;
        }
        finally
