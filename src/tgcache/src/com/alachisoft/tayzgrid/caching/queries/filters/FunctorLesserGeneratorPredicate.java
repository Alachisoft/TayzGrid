...
public class FunctorLesserGeneratorPredicate extends Predicate implements java.lang.Comparable {
    ...
    public void ExecuteInternal(QueryContext queryContext, tangible.RefObject<SortedMap> list) throws GeneralFailureException, OperationFailedException, CacheException {
        ...
        if (store != null) {
            ...
            if (getInverse()) {
                keyList = store.GetData(generator.Evaluate(((MemberFunction) functor).getMemberName(), queryContext.getAttributeValues()), ComparisonType.GREATER_THAN_EQUALS);
            } else {
                keyList = store.GetData(generator.Evaluate(((MemberFunction) functor).getMemberName(), queryContext.getAttributeValues()), ComparisonType.LESS_THAN);
            }
    ...
    public final int compareTo(Object obj) {
        if (obj instanceof FunctorLesserGeneratorPredicate) {
