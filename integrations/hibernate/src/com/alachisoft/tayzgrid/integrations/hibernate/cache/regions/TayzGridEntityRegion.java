...
public class TayzGridEntityRegion extends TayzGridTransactionalDataRegion implements EntityRegion {

    public TayzGridEntityRegion(String name, Properties properties, CacheDataDescription metaData) {
    ...
    public EntityRegionAccessStrategy buildAccessStrategy(AccessType accessType) throws CacheException {
        return TayzGridStrategyBuilder.buildEntityRegionAccessStrategy(this, accessType);
    }
}
