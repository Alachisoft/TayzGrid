...
public class ReadOnlyTayzGridRegionAccessStrategy extends TayzGridRegionAccessStrategy {

    public ReadOnlyTayzGridRegionAccessStrategy(TayzGridTransactionalDataRegion region) {
        super(region);
    }
