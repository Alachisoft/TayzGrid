...
public final class NonStrictReadWriteTayzGridEntityRegionAccessStrategy extends NonStrictReadWriteTayzGridRegionAccessStrategy implements EntityRegionAccessStrategy {

    public NonStrictReadWriteTayzGridEntityRegionAccessStrategy(TayzGridEntityRegion region) {
        super(region);
    }
