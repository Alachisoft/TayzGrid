...
public final class NonStrictReadWriteTayzGridNaturalIdRegionAccessStrategy extends NonStrictReadWriteTayzGridRegionAccessStrategy implements NaturalIdRegionAccessStrategy {

    public NonStrictReadWriteTayzGridNaturalIdRegionAccessStrategy(TayzGridNaturalIdRegion region) {
        super(region);
    }
