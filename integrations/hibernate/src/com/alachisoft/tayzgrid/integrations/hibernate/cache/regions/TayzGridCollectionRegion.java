...
public class TayzGridCollectionRegion extends TayzGridTransactionalDataRegion implements CollectionRegion {

    public TayzGridCollectionRegion(String name, Properties properties, CacheDataDescription metaData) {
    ...
    public CollectionRegionAccessStrategy buildAccessStrategy(AccessType accessType) throws CacheException {
        return TayzGridStrategyBuilder.buildCollectionRegionAccessStrategy(this, accessType);
    }
}
