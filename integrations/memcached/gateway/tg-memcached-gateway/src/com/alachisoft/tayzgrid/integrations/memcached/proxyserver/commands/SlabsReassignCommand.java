...
public class SlabsReassignCommand extends AbstractCommand {

    private int _sourceClassID;

    public final int getSourceClassID() {
        return _sourceClassID;
    }

    public final void setSourceClassID(int value) {
        _sourceClassID = value;
    }
    private int _destinationClassID;

    public final int getDestinationClassID() {
        return _destinationClassID;
    }

    public final void setDestinationClassID(int value) {
        _destinationClassID = value;
    }

    public SlabsReassignCommand(int sourceClassID, int destinationClassID) {
        super(Opcode.Slabs_Reassign);
