...
public class SlabsAutomoveCommand extends AbstractCommand {
    ...
    public final void setOption(int value) {
        _option = value;
    }

    public SlabsAutomoveCommand(int option) {
        super(Opcode.Slabs_Automove);
        _option = option;
    }
