...
public class AssemblyUsage
{
    ...
    {
        String logo = "Alachisoft (R) TayzGrid Utility - StopCache. Version " + VERSION + "\nCopyright (C) Alachisoft 2015. All rights reserved.\n";
    ...
    public static void PrintUsage()
    {
        ...
        String usage = "Usage: stopcache cache-id(s) [option[...]]." + "\r\n" + "Argument:" + "\r\n" + "  cache-id(s)" + "\r\n"
                + "    Specifies one or more id(s) of caches registered on the server. " + "\r\n" + "    The cache(s) with this/these id(s) is/are stoped on the server." + "\r\n"
