...
public class AddClientNodeParam extends com.alachisoft.tayzgrid.tools.common.CommandLineParamsBase {

    private static String _cacheId = "";
    private static int _port = -1;
    private static String _server = "";
    private static String _clientNode = "";
    private static String _bindingAddress = "";
    ...
    @ArgumentAttributeAnnontation(shortNotation = "-b", fullNotation = "--client-binding-address", appendText = "", defaultValue = "")            
    public final String getClientBindingIp() {
        return _bindingAddress;
    }
    
    @ArgumentAttributeAnnontation(shortNotation = "-b", fullNotation = "--client-binding-address", appendText = "", defaultValue = "")            
    public final void setClientBindingIp(String value) {
