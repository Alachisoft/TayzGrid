...
public final class AssemblyUsage {
    ...
    public static void PrintLogo(boolean printlogo) {
        String logo = "Alachisoft (R) TayzGrid Utility - AddStartupLoader. Version " + VERSION + "\nCopyright (C) Alachisoft 2015. All rights reserved.\n";
    ...
    public static void PrintUsage() {
        ...
        String usage = "Usage: addstartuploader  [option[...]]." + "\r\n" + "\r\n" + " " + "\r\n" +
                "    Specifies the id/name of the cache for which cache loader will be configured. " + "\r\n" + 
                "\r\n" + " -a --assembly-path" + "\r\n" + "    Specifies the path of the assembly which will be"
                + " configured as a startup loader. " + "\r\n" + "\r\n" + " -c --class" + "\r\n" + "    Specifies"
                + " the class from the startup loader which implements ICacheLoader/ICacheStartupProvider. " 
                + "\r\n" + "\r\n" + "Optional:" + "\r\n" + "\r\n" + " -l --parameter-list" + "\r\n" + "   "
                + " Specifies the list of the parameters passed to the cache loader e.g key1=value1$key2=value2..." 
                ...
                + "\r\n" + "\r\n" + " -R --retries" + "\r\n" + "    Specifies number of retries for loading data in cache"
                + "." + "\r\n" + " " + "\r\n" + " -i --retry-interval" + "\r\n" + "    Specifies the retry interval"
                + " for loading data in cache." + "\r\n" + "\r\n" + " -G" + "\r\n" + "  "
