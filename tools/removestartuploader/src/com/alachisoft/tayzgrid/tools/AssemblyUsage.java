...
public final class AssemblyUsage {
    ...
    public static void PrintLogo(boolean printlogo) {
        String logo = "Alachisoft (R) TayzGrid Utility - RemoveStartupLoader. Version " + VERSION + "\nCopyright (C) Alachisoft 2015. All rights reserved.\n";
    ...
    public static void PrintUsage() {
        ...
        String usage = "Usage: removestartuploader  [option[...]]." + "\r\n" + "\r\n" + " " + "\r\n" +
                "    Specifies the id/name of the cache for which cache loader will be removed. " + "\r\n" + "\r\n" +
