 ...
 *
 */
public class DeployAssemblyParam extends com.alachisoft.tayzgrid.tools.common.CommandLineParamsBase {

    private static String _asmPath = "";
    private static String _class = "";
    private static java.util.ArrayList _attributes = null;
    private static String _cacheId = "";
    private static String _server = "";
    private static int _port = -1;

    public DeployAssemblyParam() {
    }
