...
public final class AssemblyUsage
{
	...
	*/
	...
	{
		String logo = "Alachisoft (R) TayzGrid Utility - DeployJar. Version " + VERSION + "\nCopyright (C) Alachisoft 2015. All rights reserved.\n";
	...
	*/
	...
	public static void PrintUsage()
	{
		...
		String usage = "Usage: deployassembly  [option[...]]." + "\r\n" + "\r\n" + 
                        " " + "\r\n" + "    Specifies the id/name of the cache for assemblies deployment. " + 
                        "\r\n" + "\r\n" + " -T --path " + "\r\n" + "   "
                        + " Specifies the path of the assembly/folder for deployment." + "\r\n" + "\r\n" +
                        "Optional:" + "\r\n" + "\r\n" + " -s --server" + "\r\n" + " "
